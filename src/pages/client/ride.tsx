...
export default function ride({ drivers, vehicles }: IDeliveryProps) {
                          ...
                          (
                            <Box sx={{
                              ...
                              <Typography variant="body1" component="h6" fontWeight='semibold' color='GrayText'>
                                - Adicione uma observação para o motorista, informe em que KM você está e o KM de destino
                                 que ele irá até seu endereço.
                              </Typography>
                              {
                                isDelivery && (
                                  <Typography variant="body1" component="h6" fontWeight='semibold' color='GrayText'>
